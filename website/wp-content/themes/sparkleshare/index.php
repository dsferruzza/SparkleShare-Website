<?php get_header(); ?>
    ...
    <div class="wrapper">
      ...
      <div class="tile android enabled" onclick="location.href='https://market.android.com/details?id=org.sparkleshare.android'"><div class="os">android</div></div>
    </div>
    <div class="wrapper">
      <div class="tile-big">
        <h1>get started</h1>
        <p>Setting up your own host to work with SparkleShare is relatively easy. We've written a <a href="http://sparkleshare.org/set-up-a-host/">short page</a> about it. The <a href="/help/">documentation</a> should handle most of your questions.</p><p>If you can't set up your own host, you can always register a free account at
      ...
      <div class="tile bitcoin enabled" onclick="top.location.href='support-us/'">
